        		...
        		<div id="edt-prfle">
                	...
                	<form id="login" method="post" action="<%=request.getContextPath()%>/auth">
                     ...
                     <table id="ed-pf">
                    	...
                    	<tr>
							<td>&nbsp;</td>
							<td><input name="rType" type="hidden" onblur="ajaxcheck()" value="fpwd"><%if(isErr){ %>
							Invalid Details
							<%}%></td>
							<td>&nbsp;</td>
						</tr>
						...
						<tr>
                        	<td width="105"><label>Email</label></td>
                            <td width="142"><input name="email" type="text"  onblur="ajaxcheck()"></td>
