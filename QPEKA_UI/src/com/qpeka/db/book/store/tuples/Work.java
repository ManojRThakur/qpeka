	...
	public static Work getBookfromDBObject(BasicDBObject obj)
	{
		try 
		{
			...
			Work w = new  Work(obj.getString(ID),obj.getString(TITLE),obj.getString(AUTHORID),obj.getString(COVERPAGEFILE),
					com.qpeka.db.book.store.tuples.Constants.CATEGORY.valueOf(obj.getString(CATEGORY)),com.qpeka.db.book.store.tuples.Constants.TYPE.valueOf(obj.getString(TYPE)),
					obj.getInt(NUMPAGES),new JSONObject(obj.getString(METADATA)), obj.getString(DESCRIPTION),LANGUAGES.valueOf(obj.getString(LANGUAGE)),
